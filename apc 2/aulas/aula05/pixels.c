...
int main() {
  ...
  // insira o seu código abaixo
 for (int i = 0; i < 10; i++) {
 imagem5[0][i] = RGBA(255, 0, 0, 255); 
 imagem5[9][i] = RGBA(255, 0, 0, 255); 
 imagem5[i][0] = RGBA(255, 0, 0, 255);
 imagem5[i][9] = RGBA(255, 0, 0, 255);
 }
  // solução:  
  ...
  // solução:  
    ...
    for(int col = 0; col < 10; col++) {
        if(lin < col) {
            ...
            pchar6[(lin*10*4) + (col*4)+1] = 0; // Azul
        }
    }
  }
  ...
  // solução:  
   for (int lin = 0; lin < 10; lin++) {
    for (int col = 0; col < 10; col++) {
        if (lin <= col && lin + col < 10) {  
            int pos = (lin * 10 * 4) + (col * 4);
            pchar7[pos + 3] = 255;
            pchar7[pos + 2] = 169;
            pchar7[pos + 1] = 0;
            pchar7[pos + 0] = 0;
  ...
  // solução:  
    ...
    for(int col = 0; col < 10; col++) {
        if(lin < col) {
            pchar10[(lin*10*4) + (col*4)+3] = 255;
            pchar10[(lin*10*4) - (col*4)+2] = 0;
            pchar10[(lin*10*4) + (col*4)+1] = 0; // Azul
        }
    }
  }
  // insira o seu código acima
